...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_DISPLAY_ID="$(BUILD_ID).SC52AOMS1BUJ1" \
    BUILD_NUMBER=SC52AOMS1BUJ1 \
    PRIVATE_BUILD_DESC="y2qdcmw-user 11 RP1A.200720.012 SC52AOMS1BUJ1 release-keys" \
    PRODUCT_DEVICE=y2q \
    PRODUCT_NAME=y2qdcmw \
    TARGET_BUILD_FLAVOR="y2qdcmw-$(TARGET_BUILD_VARIANT)" \
    TARGET_DEVICE=SC-52A

BUILD_FINGERPRINT := samsung/SC-52A/SC-52A:11/RP1A.200720.012/SC52AOMS1BUJ1:user/release-keys
